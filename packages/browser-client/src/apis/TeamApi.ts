 ...
 */
import type { CreateTeamInput, DeleteSuccessDto, TeamDto } from "../models/index";
import {
...
export class TeamApi extends runtime.BaseAPI {
  /**
   */
  async teamControllerCreateRaw(
    requestParameters: TeamControllerCreateRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<TeamDto>> {
    if (
      requestParameters.createTeamInput === null ||
      requestParameters.createTeamInput === undefined
    ) {
      throw new runtime.RequiredError(
        "createTeamInput",
        "Required parameter requestParameters.createTeamInput was null or undefined when calling teamControllerCreate.",
      );
    }
  ...
  /**
   */
  async teamControllerDeleteRaw(
    requestParameters: TeamControllerDeleteRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<DeleteSuccessDto>> {
    if (requestParameters.id === null || requestParameters.id === undefined) {
      throw new runtime.RequiredError(
        "id",
        "Required parameter requestParameters.id was null or undefined when calling teamControllerDelete.",
      );
    }
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      DeleteSuccessDtoFromJSON(jsonValue),
    );
  }

  /**
   */
  async teamControllerDelete(
    requestParameters: TeamControllerDeleteRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
