...
export type FullMembershipDtoRoleEnum =
  (typeof FullMembershipDtoRoleEnum)[keyof typeof FullMembershipDtoRoleEnum];
...
export function FullMembershipDtoFromJSONTyped(
  json: any,
